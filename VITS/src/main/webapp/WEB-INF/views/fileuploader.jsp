...
<body>
	...
	<form method="POST" action="/vits/uploadFile"
	...
	<form:form method="POST" action="/spring-mvc-java/uploadMultiFile"
		enctype="multipart/form-data">
	...
	<h3>
		Fill the Form and Select a File (
	...
	<form:form method="POST"
		action="/spring-mvc-java/uploadFileModelAttribute"
		enctype="multipart/form-data">
